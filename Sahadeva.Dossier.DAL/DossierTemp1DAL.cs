...
{
   public class DossierTemp1DAL
    {
        public DataTable FetchPending_DCIDsToProcess_DT1()
        {
            ...
            try
            {
                using (DataAccessWrapper DataAccessWrapper = new DataAccessWrapper(DatabaseConstants.ConnectionString))
                {
                    ...
                    using (DbCommand dbCommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_FetchPending_DCIDsToProcess_DT1))
                    {
                        #region DataSet
        ...
        public DataTable Dossier_FetchClientData_DT1(Int32 CDID)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                {
                    //using (DbCommand dbCommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_Dossier_FetchPrintArticleData))
                    using (DbCommand dbCommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_Fetch_DataByCDID_DT1))
                    {
        ...
        public List<NewsArticle> Dossier_FetchArticleData_Print_DT1(Int32 CDID)
        {
        ...
        public List<NewsArticle_Online> Dossier_FetchArticleData_Online_DT1(Int32 CDID)
        {
        ...
        public DataSet CoverageDossier_OverView_Page_DT1(Int32 CDID)
        {
            try
            {
        ...
        public DataSet USP_CoverageDossier_OverView_Page_Data_DT4(Int32 CDID)
        {
            try
            {
                DataSet ds = new DataSet();
                using (DataAccessWrapper DataAccessWrapper = new DataAccessWrapper(DatabaseConstants.ConnectionString))
                {
                    using (DbCommand dbcommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_CoverageDossier_OverView_Page_Data_DT4))
                    {
                        DataAccessWrapper.AddInParameter(dbcommand, DatabaseConstants.CDID, DbType.Int32, CDID);
