...
namespace Sahadeva.Dossier.DAL
{
    public class dossierDAL_Old
    {
        ...
        public DataTable Dossier_FetchClientData_DT2(Int32 CDID)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                {
                    //using (DbCommand dbCommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_Dossier_FetchPrintArticleData))
                    using (DbCommand dbCommand = DataAccessWrapper.GetStoredProcCommand(DatabaseConstants.USP_Fetch_DataByCDID_DT2))
                    {
        ...
        public List<NewsArticle> Dossier_FetchArticleData_Print_DT2(Int32 CDID)
        {
        ...
        public List<NewsArticle_Online> Dossier_FetchArticleData_Online_DT2(Int32 CDID)
        {
