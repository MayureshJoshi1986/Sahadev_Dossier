<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_NL_HTML_Altr.aspx.cs" Inherits="Sahadeva_NL_Edit.Edit_NL_HTML_Altr" %>
        ...
        <table class="main" width="100%" style="padding: 40px">
          ...
          <td>
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <asp:ListView ID="lvOnlineArticles_1" runat="server" Visible="true" DataKeyNames="ArticleID,MediaTypeID" OnItemEditing="lvOnlineArticles_1_ItemEditing"
                        OnItemUpdating="lvOnlineArticles_1_ItemUpdating" OnItemDeleting="lvOnlineArticles_1_ItemDeleting"  
                        OnItemCanceling="lvOnlineArticles_1_ItemCanceling" OnItemDataBound="lvOnlineArticles_1_ItemDataBound">
                            <LayoutTemplate>
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #EBF6F5 ;" class="border_bottom">
                                    ...
                                    <td>
                                        <asp:Button ID="btnEdit_Online" runat="server" Text="Edit" CommandArgument='<%# Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                             CommandName="Edit" CssClass="formbtn" />                                                                              
                                        <asp:Button ID="btnDelete_Online" runat="server" Text="Delete Article" CommandArgument='<%# Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                            CommandName="Delete" CssClass="formbtn" />
                              ...
                              <tr style="background-color: #EBF6F5 ;" class="border_bottom">
                                    <td style="text-align: center; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">                                        
                                        <asp:Label ID="lblArticleID_Online" runat="server"  Text='<%# Eval("ArticleID") %>' ></asp:Label>
                                        <%--<%# Eval("Sr_No") %>--%>
                                    </td>
                                    <td style="text-align: center; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                        <asp:Label ID="lblMediaTypeID_Online" runat="server"  Text='<%# Eval("MediaTypeID") %>' ></asp:Label>
                                    </td>
                                    <td style="text-align: left; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                        <div style="background-color: #ClusterColour#; border-radius: 3px; color: #000000; width: fit-content;padding: 4px 4px;font-weight:bold;">
                                        <asp:TextBox ID="txtCluster_Online" runat="server" Text='<%# Eval("Cluster") %>' />
                                         </div>                                          
                                    </td >
                                    <td style="text-align: center; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;" >
                                         <asp:TextBox ID="txtHeadline_Online" runat="server" Text='<%#  Eval("Headline") %>' />
                                    </td>
                                    <td  style="text-align: left; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                         <asp:TextBox ID="txtSummary_Online" runat="server" Text='<%#  Eval("Summary") %>' />
                                    </td>
                                    <td style="text-align: left; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                        ...
                                        <div
                                          ...
                                          "
                                        >
                                        <asp:TextBox ID="txtSentiment_Online" runat="server" Text='<%#  Eval("Sentiment") %>' />
                                          &nbsp;&nbsp;
                                          <div
                                            style="
                                              margin: 2px 0px;
                                    ...
                                    <td style="text-align: left; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                        <asp:TextBox ID="txtPublication_Online" runat="server" Text='<%#  Eval("Publication") %>' />
                                    </td>
                                    
                                    <td style="text-align: left; padding: 15px 12px;font-family: Georgia;font-size: 12px;text-align: left;color: #393939;vertical-align: top;">
                                        <asp:TextBox ID="txtArticleType_Online" runat="server" Text='<%#  Eval("ArticleType") %>' />
                                    </td>
                                    <td>
                                        <asp:Button ID="btnEdit_Online" runat="server" Text="Edit" CommandArgument='<%#  Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                             CommandName="Edit" CssClass="formbtn" />                                        
                                        <asp:Button ID="btnUpdate_Online" runat="server" Text="Update" CommandArgument='<%# Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                            CommandName="Update" CssClass="formbtn" />
                                    </td>
                                </tr>
                             </EditItemTemplate>
                            <EmptyDataTemplate>
