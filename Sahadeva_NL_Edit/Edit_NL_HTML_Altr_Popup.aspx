<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_NL_HTML_Altr_Popup.aspx.cs" Inherits="Sahadeva_NL_Edit.Edit_NL_HTML_Altr_Popup" %>
...
<head>
   ...
   <script type="text/javascript">
       function openPopup(ArticleID, MediaTypeID) {
           // Change the URL to the desired page
           var popupUrl = 'http://localhost:49312/EditArticleDetails.aspx?ArticleID='+ArticleID+'&MediaTypeID='+MediaTypeID;
        ...
        <table class="main" width="100%" style="padding: 40px">
          ...
          <td>
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <asp:ListView ID="lvOnlineArticles_1" runat="server" Visible="true" DataKeyNames="ArticleID,MediaTypeID" >
                            <LayoutTemplate>
                                ...
                                <tr style="background-color: #EBF6F5 ;" class="border_bottom">
                                    ...
                                    <td>
                                        <asp:Button ID="btnEdit_Online" runat="server" Text="Edit" CommandArgument='<%# Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                           OnClientClick='<%# "return openPopup(" + Eval("ArticleID") + "," + Eval("MediaTypeID") + ");" %>'   CommandName="Edit" CssClass="formbtn" />                                                                              
                        ...
                        <asp:ListView ID="lvPrintArticles_1" runat="server" Visible="true">
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #EBF6F5 ;" class="border_bottom">
                                    ...
                                    <td>
                                        <asp:Button ID="btnEdit_Print" runat="server" Text="Edit" CommandArgument='<%# Eval("ArticleID") + "," + Eval("MediaTypeID")%>'
                                           OnClientClick='<%# "return openPopup(" + Eval("ArticleID") + "," + Eval("MediaTypeID") + ");" %>'   CommandName="Edit" CssClass="formbtn" />                                                                              
                                    </td>
                                </tr>
                            </ItemTemplate>
