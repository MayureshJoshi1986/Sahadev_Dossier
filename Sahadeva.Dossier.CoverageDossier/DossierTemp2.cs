...
{
   public class DossierTemp2
    {

       public void MainDT2(DataTable lstCDID)
       {
...
//D:\ADFACTORS\TFS Applications\PR\Workbench\Dossier Template2\Sahadeva_NewsLetter\Sahadeva.Dossier.CoverageDossier\DossierTemp2.cs
               ...
               {//var filteredRows = lstCDID.AsEnumerable().Where(row => row.Field<int>("TemplateID") == 3);
                   ...
                   try
                   {
                       ...
                       DataTable dtClient = dal.Dossier_FetchClientData_DT2(Convert.ToInt32(lstCDID.Rows[i]["CDID"]));
                       ErrorLog("Dossier_FetchClientData", "End");

                       ErrorLog("Dossier_FetchArticleData_Print", "Started");
                       lstNewsArticle = dal.Dossier_FetchArticleData_Print_DT2(Convert.ToInt32(lstCDID.Rows[i]["CDID"]));
                       ErrorLog("Dossier_FetchArticleData_Print", "End");

                       ErrorLog("Dossier_FetchArticleData_Online", "Started");
                       lstNewsArticleOnline = dal.Dossier_FetchArticleData_Online_DT2(Convert.ToInt32(lstCDID.Rows[i]["CDID"]));
                       ErrorLog("Dossier_FetchArticleData_Online", "End");

                       if (lstNewsArticle.Count > 0 || lstNewsArticleOnline.Count > 0)
                       {
                         //  dal.CoverageDossier_UpdateStatus(Convert.ToInt32(lstCDID.Rows[i]["CDID"]), Convert.ToInt32(ConfigurationManager.AppSettings["DossierGenerationStart"]));
       ...
       public static void CreateWord(List<NewsArticle> lstNewsArticle, List<NewsArticle_Online> lstNewsArticleOnline, DataTable dtClient, Int32 CDID)
       {
           ...
           try
           {
               ...
               dal.DossierGanrationLog(CDID, "FirstPage_New Started", "");
               ...
               dal.DossierGanrationLog(CDID, "FirstPage_New End", "");
               //WordAutomationObj.GotoastLinePoint();
               ...
               dal.DossierGanrationLog(CDID, "CoverageDossier_OverView_Page_DT2 Started", "");
               ...
               dal.DossierGanrationLog(CDID, "CoverageDossier_OverView_Page_DT2 End", "");

               //WordAutomationObj.GotoastLinePoint();
               //WordAutomationObj.InserLineBreak();
               dal.DossierGanrationLog(CDID, "Overview summary Started", "");
               ...
               WordAutomationObj.InserLineBreak();
               WordAutomationObj.InsertPagebreak();
               dal.DossierGanrationLog(CDID, "Overview summary End", "");


               dal.DossierGanrationLog(CDID, "Print Graph Started", "");
               ...
               dal.DossierGanrationLog(CDID, "Print Graph End", "");
               ...
               dal.DossierGanrationLog(CDID, "Inside CreateWord - Print  Started", "");
               ...
               if (lstNewsArticle.Count != 0)
               {
                   ...
                   dal.DossierGanrationLog(CDID, "InsertTable_Articles_Print  Started", "");
                   WordAutomationObj.InsertTable_Articles_Print(lstNewsArticle);
                   WordAutomationObj.GotoastLinePoint();
                   WordAutomationObj.InserLineBreak();
                   WordAutomationObj.InsertPagebreak();
                   dal.DossierGanrationLog(CDID, "InsertTable_Articles_Print  End", "");


                   dal.DossierGanrationLog(CDID, "Prominent Coverages – Print  Started", "");
                   ...
                   dal.DossierGanrationLog(CDID, "Inside CreateWord - Print    Count : " + Convert.ToString(lstNewsArticle.Count), "");

                   for (int i = 0; i < lstNewsArticle.Count; i++)
                   {
                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   Started Started lstNewsArticle Count : " + Convert.ToString(i), "");
                       ...
                       // dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   InsertHeaderTable_New_Print  Started", "");

                       WordAutomationObj.InsertHeaderTable_New_Print(objNewsArticle);

                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   InsertHeaderTable_New_Print  end", "");
                       WordAutomationObj.GotoastLinePoint();
                       WordAutomationObj.InserLineBreak();
                       ...
                       //WordAutomationObj.InserLineBreak();
                       //}
                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   Article synopsis  Started", "");
                       ...
                       WordAutomationObj.GotoastLinePoint();
                       WordAutomationObj.InserLineBreak();
                       //   dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   Article synopsis  end", "");
                       ...
                       //WordAutomationObj.GotoastLinePoint();
                       //WordAutomationObj.InserLineBreak();
                       //    dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   Article Iamge Add  Started", "");
                       //string BookMark = "B" + 1;
                       ...
                       //      dal.DossierGanrationLog(CDID, "Inside CreateWord - Print   Article Iamge Add  end", "");
                   }
               ...
               dal.DossierGanrationLog(CDID, "Insert Header and Footer   InsertHeaderandFooter  Started", "");
               ...
               //  WordAutomationObj.InsertHeaderandFooter(ClientLogoURL + EntityID + ".jpg", ADFLogoURL);
               WordAutomationObj.GotoastLinePoint();
               dal.DossierGanrationLog(CDID, "Insert Header and Footer   InsertHeaderandFooter  End", "");
               ////WordAutomationObj.InsertPagebreak();

               ErrorLog("Inside CreateWord - Print", "End");
               ErrorLog("Inside CreateWord - Online", "Started");
               dal.DossierGanrationLog(CDID, "Inside CreateWord - Online   Started", "");
               #region For Online
               ...
               if (lstNewsArticleOnline.Count != 0)
               {
                   ...
                   dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertTable_Articles_Online  Started", "");
                   WordAutomationObj.InsertTable_Articles_Online(lstNewsArticleOnline);
                   WordAutomationObj.GotoastLinePoint();
                   WordAutomationObj.InserLineBreak();
                   WordAutomationObj.InsertPagebreak();

                   dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertTable_Articles_Online  end", "");
                   ...
                   dal.DossierGanrationLog(CDID, "Inside CreateWord  Count : " + Convert.ToString(lstNewsArticleOnline.Count), "");
                   ...
                   for (int i = 0; i < lstNewsArticleOnline.Count; i++)
                   {
                       ...
                       // dal.DossierGanrationLog(CDID, "Inside CreateWord - Online Started lstNewsArticle Count : " + Convert.ToString(i), "");
                       ...
                       //WordAutomationObj.InsertDomainImageIntoBody_New(@"D:\Shivakiran\Backup_Prashant\Sahadeva_NewsLetter\Sahadeva.Dossier.CoverageDossier\Images\Publications\110.jpg");
                       //    dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertHeaderTable_New_Online  Started", "");
                       WordAutomationObj.InsertHeaderTable_New_Online(objNewsArticle);
                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertHeaderTable_New_Online  end", "");
                       WordAutomationObj.GotoastLinePoint();
                       //  WordAutomationObj.InserLineBreak();
                       ...
                       // WordAutomationObj.InserLineBreak();
                       //}
                       //   dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  Article synopsis -  Started", "");
                       WordAutomationObj.InsertBoldTextLable("Article synopsis - ");
                       ...
                       //dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  Article synopsis -  end", "");
                       ...
                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertArticleImageIntoBody -  Started", "");
                       ...
                       //WordAutomationObj.GotoastLinePoint();
                       WordAutomationObj.InsertPagebreak();
                       //  dal.DossierGanrationLog(CDID, "Inside CreateWord - Online  InsertArticleImageIntoBody -  end", "");
                       ////KillWordProcess();
                       //WordAutomationObj.GotoastLinePoint();
                       //WordAutomationObj.InsertPagebreak();
                       //ErrorLog("Inside CreateWord - Print ", "Started lstNewsArticle Count : " + Convert.ToString(i));
               ...
               //WordAutomationObj.InsertPagebreak();
               #endregion
               dal.DossierGanrationLog(CDID, "Inside CreateWord - Online   end", "");
               ErrorLog("Inside CreateWord - Online", "End");
               // WordAutomationObj.GotoastLinePoint();
               // WordAutomationObj.InserLineBreak();
               //WordAutomationObj.InsertPagebreak();
               dal.DossierGanrationLog(CDID, " Graph  Started", "");
               WordAutomationObj.PageHeading_New("Brand vs Competitor Overview-Discourse Category", "B_PageHeading_BrandCompetitor_Overview");
               WordAutomationObj.GotoastLinePoint();
               WordAutomationObj.InserLineBreak();
               ErrorLog("Brand vs Competitor overview", "Graph  Coverage Category Started");
               ...
               WordAutomationObj.GotoastLinePoint();
               WordAutomationObj.InserLineBreak();
               ErrorLog("Brand vs Competitor overview", "Graph  Article TYPE Graph  Started");
               ...
               WordAutomationObj.GotoastLinePoint();
               WordAutomationObj.InserLineBreak();
               ErrorLog("Brand vs Competitor overview", "Graph  Mention_Graph Graph   Started");
               ...
               WordAutomationObj.GotoastLinePoint();
               WordAutomationObj.InserLineBreak();
               ErrorLog("Brand vs Competitor overview", "Graph  PublicationType Graph Started");
               ...
               dal.DossierGanrationLog(CDID, " Graph  end", "");
               ...
               ErrorLog("Save Path :", SavePath + DossierFileName + ".doc");
               dal.DossierGanrationLog(CDID, " DossierGanration File save ", "");
               //string OutputFiles_URL = Convert.ToString(ConfigurationManager.AppSettings["OutputFiles_URL_DT2"]);
               //ErrorLog("Brand vs Competitor overview", "Graph  PublicationType Graph end");
               ...
               //dal.DossierGanrationLog(CDID, " Update_CD_OutputFileLink update Status ", "");
               //dal.Update_CD_OutputFileLink(Convert.ToInt32(dtClient.Rows[0]["CDID"]), OutputFiles_URL + DossierFileName + ".doc");
               //dal.DossierGanrationLog(CDID, "Dossier Generator SendMail Started ", "");
               ...
               //dal.DossierGanrationLog(CDID, "Dossier Generator SendMail end ", "");
           }
           catch (Exception ex)
           {
               dal.DossierGanrationLog(CDID, "Dossier Generator Error ", ex.ToString());
               ErrorSendMail(Convert.ToString(dtClient.Rows[0]["EmailIdsTo"]), ex.ToString(), "Dossier Generator Error- " + CDID + " Client Name " + Convert.ToString(dtClient.Rows[0]["EntityName"]), "", Convert.ToString(dtClient.Rows[0]["EmailIdsCC"]), Convert.ToString(dtClient.Rows[0]["EmailIdsBCC"]));
