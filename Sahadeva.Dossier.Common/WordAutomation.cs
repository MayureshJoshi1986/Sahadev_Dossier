...
namespace Sahadeva.Dossier.Common
{
    public class WordAutomation
    {
        ...
        public WordAutomation(string WordTemplateFilePath)
        {
            // activate the interface with the COM object of Microsoft Word
            oWord = new Microsoft.Office.Interop.Word.Application();
        ...
        public void InsertHeaderTable_New_Online(NewsArticle_Online objNewsArticle)
        {
            ...
            try
            {
                ...
                //objTable.Cell(3, 3).Merge(objTable.Cell(3, 4));
                objTable.Cell(6, 2).Merge(objTable.Cell(6, 5));
                objTable.Cell(6, 2).Range.Text = objNewsArticle.Title;
            ...
            if (!string.IsNullOrEmpty(imagePath))
            {
                if (!string.IsNullOrEmpty(imagePath))
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        //   dal.DossierGanrationLog(CDID, "FirstPage_New Started", ex.ToString());
                        // ErrorSendMail(Convert.ToString(ConfigurationManager.AppSettings["ErrorEmailID"]), " Method : FirstPage_New " + ex.ToString(), "Error Log Dossier Generator - CDID " + CDID, "", "", "");
