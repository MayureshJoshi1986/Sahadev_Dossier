...
{
   public class WordAutomationTemp4
    {
        ...
        public WordAutomationTemp4(string WordTemplateFilePath)
        {
            oWord = new Microsoft.Office.Interop.Word.Application();
        ...
        public void InsertHeaderTable_New_Print(NewsArticle objNewsArticle)
        {
            ...
            try
            {
                ...
                Microsoft.Office.Interop.Word.Table objTable;
                Microsoft.Office.Interop.Word.Range wrdRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
                objTable = oDoc.Tables.Add(wrdRng, 5, 4, ref oMissing, ref oMissing);
               ...
               // objTable.Columns[5].Width = 60;
                ...
                objTable.Cell(1, 3).Range.Text = "Edition";
                objTable.Cell(1, 4).Range.Text = "Page No. ";
               ...
               // objTable.Cell(2, 3).Range.Text = objNewsArticle.PublicationType;//
                objTable.Cell(2, 3).Range.Text = objNewsArticle.Edition;
                objTable.Cell(2, 4).Range.Text = objNewsArticle.Pageno;
                ...
                objTable.Cell(5, 2).Range.Text = objNewsArticle.HeadLine;              
        ...
        public void InsertHeaderTable_New_Online(NewsArticle_Online objNewsArticle)
        {
            ...
            try
            {
                ...
                Microsoft.Office.Interop.Word.Table objTable;
                Microsoft.Office.Interop.Word.Range wrdRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
                objTable = oDoc.Tables.Add(wrdRng, 5, 3, ref oMissing, ref oMissing);
                objTable.Range.ParagraphFormat.SpaceAfter = 1;
                objTable.Rows.Alignment = WdRowAlignment.wdAlignRowCenter;

                // Set column widths (adjust as needed)
                objTable.Columns[1].Width = 140;
                objTable.Columns[2].Width = 140;
                objTable.Columns[3].Width = 140;
               // objTable.Columns[4].Width = 100;
               // objTable.Columns[5].Width = 60;
