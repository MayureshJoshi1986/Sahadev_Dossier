...
{
    public class WordAutomationTemp3
    {
        ...
        Color Lightbluecolor = Color.FromArgb(213, 213, 221);
        ...
        public WordAutomationTemp3(string WordTemplateFilePath)
        {
            // activate the interface with the COM object of Microsoft Word
            oWord = new Microsoft.Office.Interop.Word.Application();
        ...
        public void InsertHeaderandFooter(string HeaderImageUrl, string FooterImageUrl)
        {
            ...
            foreach (Section section in oDoc.Sections)
            {
                ...
                word.HeaderFooter header = section.Headers[WdHeaderFooterIndex.wdHeaderFooterPrimary];
                Shape oheader = header.Shapes.AddPicture(HeaderImageUrl, oMissing, oMissing, -20, -20);
                oheader.Left = section.PageSetup.PageWidth - oheader.Width - 250; //(section.PageSetup.PageWidth - oheader.Width) / 2;  //
                oheader.Top = -10;
                ...
                if (FooterImageUrl != "")
                {
                    ...
                    Shape ofooter = footer.Shapes.AddPicture(FooterImageUrl, oMissing, oMissing, -20, -20);
                    //ofooter.Left = section.PageSetup.PageWidth + 150;
                    ofooter.Left = 130;
                    ofooter.Top = 740;
                    //ofooter.Top = footer.Range.Information[WdInformation.wdVerticalPositionRelativeToPage];
        ...
        public void InsertBoldTextLableTitle(string lable)
        {

            oWord.Selection.ParagraphFormat.Alignment = Microsoft.Office.Interop.Word.WdParagraphAlignment.wdAlignParagraphLeft;
            oWord.Selection.Font.Color = WdColor.wdColorOrange;
            oWord.Selection.Font.Size = 15;
            oWord.Selection.Font.Bold = 2;
            oWord.Selection.TypeText(lable);

            // (WdColor)ColorTranslator.ToOle(Orangecolor);// Microsoft.Office.Interop.Word.WdColor.Orangecolor;
        ...
        public void InsertHeaderTable_New_Print(NewsArticle objNewsArticle)
        {
            ...
            try
            {
                ...
                {
                    string ArticleType = objNewsArticle.ArticleType.Substring(0, objNewsArticle.ArticleType.Length - 2);
                    objTable.Cell(4, 4).Range.Text = ArticleType;
                }
                ...
                objTable.Cell(5, 4).Range.Text = "Discourse Category";
                ...
                if (objNewsArticle.CoverageCategory.EndsWith(", "))
                {
                    string CoverageCategory = objNewsArticle.CoverageCategory.Substring(0, objNewsArticle.CoverageCategory.Length - 2);
                    objTable.Cell(6, 4).Range.Text = CoverageCategory;
                }
                ...
                //objTable.Cell(6, 1).Range.Text = "Coverage Category: ";
                //objTable.Cell(6, 2).Merge(objTable.Cell(6, 5));

                //if (objNewsArticle.CoverageCategory.EndsWith(", "))
                //{
                //    string CoverageCategory = objNewsArticle.CoverageCategory.Substring(0, objNewsArticle.CoverageCategory.Length - 2);
                //    objTable.Cell(6, 2).Range.Text = CoverageCategory;
                //}
        ...
        public void InsertHeaderTable_New_Online(NewsArticle_Online objNewsArticle)
        {
            ...
            try
            {
                ...
                Microsoft.Office.Interop.Word.Table objTable;
                Microsoft.Office.Interop.Word.Range wrdRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
                objTable = oDoc.Tables.Add(wrdRng, 6, 5, ref oMissing, ref oMissing);
                objTable.Range.ParagraphFormat.SpaceAfter = 1;
                objTable.Rows.Alignment = WdRowAlignment.wdAlignRowCenter;
                ...
                objTable.Cell(2, 2).Range.Text = objNewsArticle.Publication;
                objTable.Cell(2, 3).Range.Text = objNewsArticle.PublicationType;
                if (string.IsNullOrEmpty(objNewsArticle.DA))
                {
                    objTable.Cell(2, 4).Range.Text = "NA";
                }
                else
                {
                ...
                if (string.IsNullOrEmpty(objNewsArticle.NewsTraffic))
                {
                ...
                objTable.Cell(4, 3).Range.Text = objNewsArticle.pi_score;


                objTable.Cell(5, 1).Range.Text = "Discourse Category: ";
                objTable.Cell(5, 2).Merge(objTable.Cell(5, 5));

                if (objNewsArticle.CoverageCategory.EndsWith(", "))
                {
                    string CoverageCategory = objNewsArticle.CoverageCategory.Substring(0, objNewsArticle.CoverageCategory.Length - 2);
                    objTable.Cell(5, 2).Range.Text = CoverageCategory;
                }
                ...
                objTable.Cell(6, 1).Range.Text = "Headline: ";
                //objTable.Cell(3, 2).Merge(objTable.Cell(3, 3));
                //objTable.Cell(3, 3).Merge(objTable.Cell(3, 4));
                objTable.Cell(6, 2).Merge(objTable.Cell(6, 5));
                objTable.Cell(6, 2).Range.Text = objNewsArticle.NewsURL;
                ...
                Object oRange = objTable.Cell(6, 2).Range;
                wrdRng.Hyperlinks.Add(oRange, ref linkAddrNewsURL, ref oMissing, ref HeadlineNewsURL, ref HeadlineNewsURL, ref oMissing);
                ...
                objTable.Cell(6, 1).Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(FadedOrangecolor);
        ...
        public void PageHeading_New(string Text, string objBookmark)
        {
            ...
            table1.Rows[1].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(Lightbluecolor);
            table1.Rows[1].Range.Font.Bold = 600;
            table1.Rows[1].Range.Font.Color = WdColor.wdColorOrange;
            ...
            try
            {
                ...
                for (int row = 1; row <= rows; row++)
                {
                    ...
                    if (row == 1)
                    {
                        ...
                        table.Rows[row].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(Lightbluecolor);
        ...
        public void CreateSimpleTable_Overview_Print(DataTable dt)
        {
            try
            {
                ...
                // Set column widths (adjust as needed)
                objTable.Columns[1].Width = 100;
                objTable.Columns[2].Width = 110;
                objTable.Columns[3].Width = 100;


                objTable.Rows[1].Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                objTable.Rows[1].Range.Font.Color = WdColor.wdColorBlack;
                objTable.Rows[2].Range.Font.Color = WdColor.wdColorBlack;

                // Add columns headers
                objTable.Cell(1, 1).Range.Text = "Total Articles: " + dt.Rows[0][0].ToString();
                objTable.Cell(1, 2).Range.Text = "Total Publications: " + dt.Rows[0][1].ToString();
                objTable.Cell(1, 3).Range.Text = "Unique Authors: " + dt.Rows[0][4].ToString();


                objTable.Cell(2, 1).Range.Text = "Total Circulation: " + dt.Rows[0][2].ToString();
                objTable.Cell(2, 2).Range.Text = "Total AVE: " + dt.Rows[0][3].ToString();
                objTable.Cell(2, 3).Range.Text = "Total Editions: " + dt.Rows[0][5].ToString();
                ...
                objTable.Rows[2].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(Lightbluecolor);
        ...
        public void CreateSimpleTable_Overview_Online(DataTable dt)
        {
            try
            {
                ...
                // Set column widths (adjust as needed)
                objTable.Columns[1].Width = 140;
                objTable.Columns[2].Width = 110;
                objTable.Columns[3].Width = 150;
                ...
                objTable.Cell(2, 1).Range.Text = "Total Traffic From India: " + dt.Rows[0][2].ToString();
                objTable.Cell(2, 2).Range.Text = "Total AVE: " + dt.Rows[0][3].ToString();
                objTable.Cell(2, 3).Range.Text = "Average Domain Authority: " + dt.Rows[0][5].ToString();
        ...
        public void CreateSimpleTable_Overview_Tweets(DataTable dt)
        {
            try
            {
                ...
                // Set column widths (adjust as needed)
                objTable.Columns[1].Width = 90;
                objTable.Columns[2].Width = 105;
                objTable.Columns[3].Width = 120;
                ...
                // Add columns headers
                objTable.Cell(1, 1).Range.Text = "Total Tweets: " + dt.Rows[0][0].ToString();
                objTable.Cell(1, 2).Range.Text = "Total Reach: " + dt.Rows[0][1].ToString();
                objTable.Cell(1, 3).Range.Text = "Total Engagement: " + dt.Rows[0][2].ToString();


                objTable.Cell(2, 1).Range.Text = "Total Views: " + dt.Rows[0][5].ToString();
                objTable.Cell(2, 2).Range.Text = "Total Retweets: " + dt.Rows[0][3].ToString();
                objTable.Cell(2, 3).Range.Text = "Total Participants: " + dt.Rows[0][4].ToString();
                ...
                objTable.Rows[1].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(Lightbluecolor);
        ...
        public void CreateTweetsByReach(int rows, int columns, DataTable dt, string objBookmark)
        {
            try
            {
                rows = rows + 1;
                ...
                table.Cell(1, 1).Range.Text = "Tweet link";
                table.Cell(1, 2).Range.Text = "Profile";
                table.Cell(1, 3).Range.Text = "Sentiment";
                table.Cell(1, 4).Range.Text = "Reach";
                table.Cell(1, 5).Range.Text = "Engagement";
                table.Cell(1, 6).Range.Text = "Retweet";

                table.Cell(1, 4).Range.Font.Size = 17.0f;

                table.Rows[1].Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                table.Rows[1].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(FadedOrangecolor);

                table.Rows[1].Range.Bold = 1;
                table.Rows[1].Range.Font.Size = 10.0f;
                ...
                for (int row = 1; row < rows; row++)
                {
                    ...
                    for (int col = 0; col < columns; col++)
                    {
                        ...
                        string originalText = Convert.ToString(dt.Rows[row - 1][col]);

                        if (col == 0 && row == 1)
                        {
                            // originalText = "1st tweet";

                            Object oRange = table.Cell(2, 1).Range;

                            object linkAddrNewsURL = Convert.ToString(dt.Rows[row - 1][col]);
                            // object HeadlineNewsURL = originalText;
                            object HeadlineNewsURL = Convert.ToString(dt.Rows[row - 1][8]);
                            wrdRng.Hyperlinks.Add(oRange, ref linkAddrNewsURL, ref oMissing, ref HeadlineNewsURL, ref HeadlineNewsURL, ref oMissing);

                        }
                        else if (col == 0 && row == 2)
                        {
                            // originalText = "2nd tweet";

                            Object oRange = table.Cell(3, 1).Range;
                        ...
                        {
                            //originalText = "3rd tweet";

                            Object oRange = table.Cell(4, 1).Range;
                        ...
                        {
                            // originalText = "4th tweet";

                            Object oRange = table.Cell(5, 1).Range;
                        ...
                        {
                            // originalText = "5th tweet";

                            Object oRange = table.Cell(6, 1).Range;
                        ...
                        {
                            table.Cell(row + 1, col + 1).Range.Text = originalText;
                        }
                        ...
                        GotoastLinePoint();
                        // Center align text in the cell
                        table.Cell(row + 1, col + 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;

                        // Set vertical alignment for the specified cell
                        table.Cell(row + 1, col + 1).VerticalAlignment = WdCellVerticalAlignment.wdCellAlignVerticalCenter;


                        table.Cell(row + 1, col + 1).Range.Borders.InsideColor = (WdColor)ColorTranslator.ToOle(FadedOrangecolor);
                        table.Cell(row + 1, col + 1).Range.Borders.OutsideColor = (WdColor)ColorTranslator.ToOle(FadedOrangecolor);


                        table.Cell(row + 1, col + 1).Range.Font.Size = 9.0f;

                        table.Cell(row + 1, col + 1).Height = 22;
                        table.Cell(row + 1, col + 1).Height = 22;
                        //table.Cell(row, col).Width = 5.0f;
        ...
        public void CreateTableofContentsPrint(int rows, int columns, DataTable dt, string objBookmark)
        {
            try
            {
                rows = rows + 1;
                ...
                table.Cell(1, 1).Range.Text = "Article";
                table.Cell(1, 2).Range.Text = "Publication";
                table.Cell(1, 3).Range.Text = "Circulation";
                table.Cell(1, 4).Range.Text = "AVE";
                table.Cell(1, 5).Range.Text = "Sentiment";
                table.Cell(1, 6).Range.Text = "Mention type";

                table.Cell(1, 4).Range.Font.Size = 17.0f;

                table.Rows[1].Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                table.Rows[1].Range.Shading.BackgroundPatternColor = (WdColor)ColorTranslator.ToOle(Lightbluecolor);
                ...
                for (int row = 1; row < rows; row++)
                {
                    ...
                    for (int col = 0; col < columns; col++)
                    {
                        ...
                        if (col == 0 && row == 1)
                        {
                            ...
                            object linkAddrNewsURL = Convert.ToString(dt.Rows[row - 1][6]);
                            // object HeadlineNewsURL = originalText;
                            object HeadlineNewsURL = Convert.ToString(dt.Rows[row - 1][col]);
                            wrdRng.Hyperlinks.Add(oRange, ref linkAddrNewsURL, ref oMissing, ref HeadlineNewsURL, ref HeadlineNewsURL, ref oMissing);
        ...
        public void CreateTableofContentsOnline(int rows, int columns, DataTable dt, string objBookmark)
        {
            try
            {
                rows = rows + 1;
                ...
                table.Cell(1, 1).Range.Text = "Article";
                table.Cell(1, 2).Range.Text = "Publication";
                table.Cell(1, 3).Range.Text = "Traffic";
                table.Cell(1, 4).Range.Text = "Domain Authority";
                table.Cell(1, 5).Range.Text = "Sentiment";
                table.Cell(1, 6).Range.Text = "Mention type";
        ...
        public bool SaveImageFromUrl(string strURL, string strFileName)
        {
            ...
            try
            {
                ...
                string strFetchurl = "https://api.urlbox.io/v1/4G9b0Mqi6yniUmhs/png?url=" + HttpUtility.UrlEncode(strURL) + "&selector=%23tblChart&" + Convert.ToString(ConfigurationManager.AppSettings["GraphImageswithHight"]) + "&delay=30000";
        ...
        public bool SaveImageFromUrl_Graph(string strURL, string strFileName)
        {
            bool IsSuccesful = false;
            string url = "";
            try
            {
                ...
                //https://api.urlbox.io/v1/H6TxTXZQLfWwBNl8/png?full_page=true
                //https://api.urlbox.io/v1/DeJyUFW6FSu4yLIt/png?url=https%3A%2F%2Faidossier.adfactorspr.com%2FDossierChart.aspx%3FCDID%3D21%26count%3D1&selector=%23chart1_container&delay=6000
                string strFetchurl = System.Configuration.ConfigurationManager.AppSettings["Screenshot_APIUrlGraph"].Replace("&amp;", "&").Replace("myurl", HttpUtility.UrlEncode(strURL));
                // string strFetchurl = "https://api.urlbox.io/v1/4G9b0Mqi6yniUmhs/png?url=" + HttpUtility.UrlEncode(strURL) + "&selector=%23Table1&width=987&height=987";
                strFetchurl = strFetchurl.Replace("\r\n", "");
        ...
        public void InsertTable_Twitter_Data(List<Twitter> lstTwitterData)
        {
            try
            {
                ...
                // Add columns headers
                objTable.Cell(1, 1).Range.Text = "Total no. of media and influencers";
                objTable.Cell(1, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                objTable.Cell(1, 2).Range.Text = lstTwitterData[0].Totalnoofmediaandinfluencers;

                objTable.Cell(2, 1).Range.Text = "Active Participants";
                objTable.Cell(2, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                objTable.Cell(2, 2).Range.Text = lstTwitterData[0].ActiveParticipants;

                objTable.Cell(3, 1).Range.Text = "New participants";
                objTable.Cell(3, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                objTable.Cell(3, 2).Range.Text = lstTwitterData[0].Newparticipants;

                objTable.Cell(4, 1).Range.Text = "Total threads";
                objTable.Cell(4, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                objTable.Cell(4, 2).Range.Text = lstTwitterData[0].Totalthreads;


                //objTable.Cell(5, 1).Range.Text = "Total no. of participants (profiles)";
                //objTable.Cell(5, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                //objTable.Cell(5, 2).Range.Text = lstTwitterData[0].Totalnoof_Participants_Profiles;

                //objTable.Cell(6, 1).Range.Text = "Total no. of media and influencers";
                //objTable.Cell(6, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                //objTable.Cell(6, 2).Range.Text = lstTwitterData[0].Totalnoof_Media_and_Influencers;

                //objTable.Cell(7, 1).Range.Text = "Total no. of threads";
                //objTable.Cell(7, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                //objTable.Cell(7, 2).Range.Text = lstTwitterData[0].Totalnoof_threads;

                //objTable.Cell(8, 1).Range.Text = "Total views";
                //objTable.Cell(8, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                //objTable.Cell(8, 2).Range.Text = lstTwitterData[0].Total_Views;
        ...
        public void Table_of_Contents_Print()
        {
            try
            {
                ...
                // Add columns headers
                objTable.Cell(1, 1).Range.Text = "Sr.no.";
                objTable.Cell(1, 2).Range.Text = "Content";


                objTable.Cell(2, 1).Range.Text = "1";
                objTable.Cell(2, 2).Range.Text = "Top articles by circulation";
                objTable.Cell(2, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(3, 1).Range.Text = "2";
                objTable.Cell(3, 2).Range.Text = "Top articles by AVE";
                objTable.Cell(3, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(4, 1).Range.Text = "3";
                objTable.Cell(4, 2).Range.Text = "Top articles with positive sentiment";
                objTable.Cell(4, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;


                objTable.Cell(5, 1).Range.Text = "4";
                objTable.Cell(5, 2).Range.Text = "Top articles with negative sentiment";
                objTable.Cell(5, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(6, 1).Range.Text = "5";
                objTable.Cell(6, 2).Range.Text = "Top articles with exclusive mention ";
                objTable.Cell(6, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(7, 1).Range.Text = "6";
                objTable.Cell(7, 2).Range.Text = "Top articles with industry mention";
                objTable.Cell(7, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
                ...
                // objTable.Cell(1, 3).Range.Text = lstTwitterData.;
        ...
        public void Table_of_Contents_Online()
        {
            try
            {
                ...
                objTable.Cell(2, 1).Range.Text = "1";
                objTable.Cell(2, 2).Range.Text = "Top articles by traffic";
                objTable.Cell(2, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(3, 1).Range.Text = "2";
                objTable.Cell(3, 2).Range.Text = "Top articles by DA";
                objTable.Cell(3, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
        ...
        public void Table_of_Contents_Twitter()
        {
            try
            {
                ...
                objTable.Cell(2, 1).Range.Text = "1";
                objTable.Cell(2, 2).Range.Text = "Top tweets by reach";
                objTable.Cell(2, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(3, 1).Range.Text = "2";
                objTable.Cell(3, 2).Range.Text = "Top tweets by engagement";
                objTable.Cell(3, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;

                objTable.Cell(4, 1).Range.Text = "3";
                objTable.Cell(4, 2).Range.Text = "Tweets with maximum retweets";
                objTable.Cell(4, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;


                objTable.Cell(5, 1).Range.Text = "4";
                objTable.Cell(5, 2).Range.Text = "Tweets by top media and influencers";
                objTable.Cell(5, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphLeft;
        ...
        public void CreateImages_Add(DataTable dt, string ArticleIamgeURL)
        {
            try
            {
                ...
                // Get the range of the first cell in the new row

                if (dt.Rows[0]["Images_Name"].ToString() != "")
                {
                    Microsoft.Office.Interop.Word.Range cellRange = objTable.Cell(1, 1).Range;
                    cellRange.InlineShapes.AddPicture(ArticleIamgeURL + dt.Rows[0]["Images_Name"].ToString());
                    cellRange.InlineShapes[1].Width = 200;
                    cellRange.InlineShapes[1].Height = 150;
                }
                if (dt.Rows[1]["Images_Name"].ToString() != "")
                {
                    Microsoft.Office.Interop.Word.Range cellRange1 = objTable.Cell(1, 2).Range;

                    cellRange1.InlineShapes.AddPicture(ArticleIamgeURL + dt.Rows[1]["Images_Name"].ToString());
                    cellRange1.InlineShapes[1].Width = 200;
                    cellRange1.InlineShapes[1].Height = 150;

                }
                if (dt.Rows[2]["Images_Name"].ToString() != "")
                {
                    Microsoft.Office.Interop.Word.Range cellRange2 = objTable.Cell(2, 1).Range;

                    cellRange2.InlineShapes.AddPicture(ArticleIamgeURL + dt.Rows[2]["Images_Name"].ToString());
                    cellRange2.InlineShapes[1].Width = 200;
                    cellRange2.InlineShapes[1].Height = 150;
                }
                if (dt.Rows[3]["Images_Name"].ToString() != "")
                {

                    Microsoft.Office.Interop.Word.Range cellRange3 = objTable.Cell(2, 2).Range;

                    cellRange3.InlineShapes.AddPicture(ArticleIamgeURL + dt.Rows[3]["Images_Name"].ToString());
                    cellRange3.InlineShapes[1].Width = 200;
                    cellRange3.InlineShapes[1].Height = 150;

                }
                if (dt.Rows[4]["Images_Name"].ToString() != "")
                {
                    Microsoft.Office.Interop.Word.Range cellRange4 = objTable.Cell(3, 1).Range;

                    cellRange4.InlineShapes.AddPicture(ArticleIamgeURL + dt.Rows[2]["Images_Name"].ToString());
                    cellRange4.InlineShapes[1].Width = 200;
                    cellRange4.InlineShapes[1].Height = 150;
                }
            }
            catch (Exception)
            {
        ...
        public void InsertTwitterImageIntoBody(string URL)
        {
            //object oRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
            //Microsoft.Office.Interop.Word.Range wrdRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
            //wrdRng = oDoc.Bookmarks.get_Item(ref oEndOfDoc).Range;
